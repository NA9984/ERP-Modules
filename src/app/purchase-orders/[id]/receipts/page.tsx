...
export default function PurchaseReceiptsPage() {
  ...
  async function confirmReceipt() {
    ...
    try {
      await fetch(
        `${API_BASE_URL}/api/app/purchase-receipt/confirm/${selectedReceipt.id}`,
        {
          method: "POST",
        }
      );
  ...
  async function returnReceipt() {
    ...
    try {
      await fetch(
        `${API_BASE_URL}/api/app/purchase-receipt/return/${selectedReceipt.id}`,
        {
          method: "POST",
        }
      );
                    ...
                    >
                      ...
                      <td className="p-4">
                        ...
                        <button
                          onClick={() =>
                            router.push(
                              `/purchase-orders/${purchaseOrderId}/receipts/${receipt.id}`
                            )
                          }
                          className="
                          text-blue-400
